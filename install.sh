...
set_permissions() {
  ...
  find $MODPATH/system -type f -exec chmod 755 {} \+;
  find $MODPATH/system -type l -exec chmod 755 {} \+;

  ui_print "[3/5] Installing to /data/tmux..";
  mv $MODPATH/custom/data/tmux /data/tmux;
  chown -R 0:0 /data/tmux;
  chmod -R 755 /data/tmux;
  find /data/tmux -type d -exec chmod 755 {} \+;
  find /data/tmux -type f -exec chmod 755 {} \+;
  find /data/tmux -type l -exec chmod 755 {} \+;
